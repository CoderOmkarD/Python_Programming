...
def main():
    ...
    Border = "-" * 50
    print(Border)
    print("-----Directory Copy System With Given Extension------")
    print(Border)

    if len(sys.argv) == 2:
        if sys.argv[1] == "--h" or sys.argv[1] == "--H":
            print("This Script is used to :")
            print("1 :Copy the files with given extension to the new folder..")
            print("2 :By using the command line input ..")

        elif sys.argv[1] == "--u" or sys.argv[1] == "--U":
            print("Use the automation script as")
            print("ScriptName.py SourceDirectory DestinationDirectory  Extension")
            print("SourceDirectory : Name of Directory to Search From")
            print(
                "DestinationDirectory : Name of the Directory you want to copy the data"
            )
            print("Extension : The extension of the files you want to copy ")
