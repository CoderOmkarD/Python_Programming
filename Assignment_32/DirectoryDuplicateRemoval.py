...
def main():
    ...
    Border = "-" * 50
    print(Border)
    print("-----Directory Remove Duplicates System------")
    print(Border)
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "--h" or sys.argv[1] == "--H":
            ...
            print(
                "2 :And Create A log file Named as log.txt add the "
                "names of duplicates files into log file"
                " And remove that duplicates files"
            )
