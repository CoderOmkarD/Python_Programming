...
def main():
    ...
    Border = "-" * 50
    print(Border)
    print("-----Directory Get Duplicates System------")
    print(Border)
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "--u" or sys.argv[1] == "--U":
            ...
            print(
                "2 :And Create A log file Named as log.txt add the names of duplicates files into log file"
            )
            ...
            print(
                "SourceDirectory : Name of Directory to get duplicates  file from"
            )
